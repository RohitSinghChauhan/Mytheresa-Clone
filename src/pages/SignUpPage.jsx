        ...
        <Box w={{ lg: '100%', md: '100%', sm: '100%', base: '98%' }} h={['80vh', '75vh', '75vh', '75vh']} margin='auto' mt={10} mb={['10', '10', '8', '-10']}>
            <Flex h='100%' direction='column' justifyContent='center' alignItems='center'>
                <Stack w={{ lg: '38vw', md: '70vw', sm: '70vw', base: '90vw' }} margin='auto' spacing={7}>
                    <Stack>
                        <Text>Fill up the details with valid email address</Text>
                    </Stack>
                    ...
                    <Stack spacing={4}>
                        ...
                        <Link to='/login'>
                            <Text textDecoration='underline'>Alrady have an account?</Text>
                        </Link>
                    </Stack>
                ...
                <Stack w={{ lg: '38vw', md: '70vw', sm: '70vw', base: '90vw' }} margin='auto' mt={1} spacing={{ lg: '2', md: '4', sm: '3' }}>
                    <Button onClick={handleSubmit} borderRadius='0' w={{ lg: '7vw', md: '12vw', sm: '12vw', base: '25vw' }} fontSize='0.9rem' bgColor='green.500' colorScheme='green' color='white' mb='1rem'>SIGN UP</Button>
